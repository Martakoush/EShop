            ...
            <div style={{backgroundColor:data.bgColor}} className='container'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                    <div className='p-6 sm:p-8'>
                        ...
                        <p classN data-aos='fade-up' ame='text-sm'>{data.date}</p>
                    </div>
                    <div data-aos='zoom-in' className='h-full flex items-center'>
                        <img src={data.image} alt='' className='scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover'></img>
                    </div>
