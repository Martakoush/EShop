            ...
            <div className='container'>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className='py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image1} alt='' className='w-[320px] absolute bottom-0'></img>
                    </div>
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image2} alt='' className='w-[320px] absolute -right-10 top-5'></img>
                    </div>
                    <div className='sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/70 text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image3} alt='' className='w-[250px] absolute top-1/2 -translate-y-1/2 right-0'></img>
                    </div>
                </div>
            </div>
        </div>
