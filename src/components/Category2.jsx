        ...
        <div className='py-8'>
            <div className='container'>
                ...
                <div className='sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image1} alt='' className='w-[250px] absolute top-1/2 -translate-y-1/2 right-0'></img>
                    </div>
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/70 text-white rounded-3xl relative h-[320px] flex items-start'>
                        ...
                        <img src={Image2} alt='' className='w-[320px] absolute bottom-[0] left-[-10px]'></img>
                    </div>
                    <div className='py-10 pl-5 bg-gradient-to-br from-brandBlue to-brandBlue/90 text-white rounded-3xl relative h-[320px] flex items-start'>
                        ...
                        <img src={Image3} alt='' className='w-[250px] absolute -right-0 bottom-0'></img>
                    </div>
                </div>
            </div>
        </div>
